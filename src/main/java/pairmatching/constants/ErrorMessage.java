...
public class ErrorMessage {
    public static final String SKILL_MENU_REGEX_ERROR_MESSAGE = "[ERROR] 없는 기능입니다.";
    public static final String COURSE_LEVEL_MISSION_REGEX_ERROR_MESSAGE = "[ERROR] 쉼표(,)를 기준으로 과정, 레벨, 미션을 순서대로 입력해 주세요.";
